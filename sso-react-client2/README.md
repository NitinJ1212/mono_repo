...
```sql
UPDATE clients
SET logout_uri = 'http://localhost:4001/backchannel-logout'
...
8. SSO redirects browser → GET http://localhost:4001/auth/callback?code=...&state=...
9. Backend:
...
2. SSO calls POST http://localhost:4001/backchannel-logout { user_id }
